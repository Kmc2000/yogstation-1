...
/mob/living/carbon/human/borgqueen/New()
	...
	for(var/mob/living/carbon/human/borgqueen/Q in living_mob_list)
		if(Q == src)
			continue
		if(Q.stat == DEAD)
			continue
...
//	AddAbility(new/obj/effect/proc_holder/alien/royal/queen/promote()
	...
	ticker.mode.greet_borg(meme)
	ticker.mode.forge_borg_objectives(meme)
